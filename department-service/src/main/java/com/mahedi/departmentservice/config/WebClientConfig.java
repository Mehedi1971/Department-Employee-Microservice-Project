package com.mahedi.departmentservice.config;
...
//
//    private final LoadBalancedExchangeFilterFunction loadBalancerFunction;
//
//    @Bean
//    @LoadBalanced
//    public WebClient.Builder loadBalancedWebClientBuilder() {
//        return WebClient.builder().filter(loadBalancerFunction);
//    }
//
//    @Bean
//    public WebClient employeeWebClient(WebClient.Builder webClientBuilder) {
//        return webClientBuilder.baseUrl("http://employee-service").build();
//    }
//
//    @Bean
